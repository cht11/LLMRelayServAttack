...
const OAUTH_PROVIDERS = {
  [OAUTH_PROVIDER_GEMINI_CLI]: {
    ...
    clientId:
      ...
      'YOUR_GEMINI_CLI_CLIENT_ID',
    clientSecret: process.env.GEMINI_OAUTH_CLIENT_SECRET || 'YOUR_GEMINI_CLI_CLIENT_SECRET',
  ...
  [OAUTH_PROVIDER_ANTIGRAVITY]: {
    ...
    clientId:
      ...
      'YOUR_ANTIGRAVITY_CLIENT_ID',
    clientSecret:
      process.env.ANTIGRAVITY_OAUTH_CLIENT_SECRET || 'YOUR_ANTIGRAVITY_CLIENT_SECRET',
    scopes: [
